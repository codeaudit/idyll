...
const allowedProps = ['domain', 'children'];
  ...
  renderEditing() {
    ...
    return (
      <div style={{ paddingTop: 15 }}>
        ...
        <input type='range' value={d3.format('0.1f')(this.props[this.state.var])} min={d[0]} max={d[1]} onChange={this.handleRangeUpdate.bind(this)} step={0.1} />
      </div>
    );
  }
